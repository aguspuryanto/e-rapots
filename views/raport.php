        ...
        <form action="<?=base_url('raport/cetak');?>" method="post">
            <div class="box-header">
                <div class="row">
                    ...
                    <!-- Adab, Kedisiplinan, dan Kerapian -->
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Adab<span class="text-red">*</span></label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Kedisiplinan<span class="text-red">*</span></label>
                            <select class="form-control" name="kedisiplinan" required>
                                <option value="A">A</option>
                                <option value="B">B</option>
                                <option value="C">C</option>
                                <option value="D">D</option>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Kerapian<span class="text-red">*</span></label>
                            <select class="form-control" name="kerapian" required>
                                <option value="A">A</option>
                                <option value="B">B</option>
                                <option value="C">C</option>
                                <option value="D">D</option>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Catatan Wali Kelas<span class="text-red">*</span></label>
                            <textarea class="form-control" name="catatan_wali" rows="4" placeholder="Masukkan catatan wali kelas di sini..." required></textarea>
                        </div>
                    </div>
