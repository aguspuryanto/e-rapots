        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview <?=isset($master)?'active':'';?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li <?=isset($pengguna)?'class="active"':'';?>><a
                                    ...
                                    Pengguna</a></li>
                            <li <?=isset($kitab)?'class="active"':'';?>><a href="<?=site_url('master/kitab');?>"><i class="fa fa-angle-double-right"></i>Kitab</a></li>
                        </ul>
                    </li>
                    ...
                    <li <?=isset($report)?'class="active"':'';?>>
                        <a href="<?=base_url('leger');?>">
                            <i class="fa fa-print"></i> <span>Cetak Leger</span>
                        </a>
                    </li>
                    <?php endif;?>
